...
SRC = main.c src/env_data.c src/signals.c \
		...
		executor/executor.c executor/executor2.c executor/executor_heredoc.c executor/executor_pipe.c executor/executor_pipe2.c executor/executor_redir.c executor/executor_builtin.c \
		executor/executor_utils.c executor/executor_utils2.c executor/executor_utils3.c \
